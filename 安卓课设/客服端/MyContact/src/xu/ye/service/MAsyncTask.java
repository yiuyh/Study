...
public class MAsyncTask extends AsyncTask<Cursor, Void, ArrayList<ContactBean>>{//子类化AsyncTask，获取手机联系人
		...
		if (cursor != null && cursor.getCount() > 0) {
			try {
				...
				for (int i = 0; i < cursor.getCount(); i++) {
					...
					if (contactInfo.getDisplayName() == null) {//若没有昵称，以手机号代替
