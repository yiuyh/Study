...
from App.views_constant import ALL_TYPE, ORDER_TOTAL, ORDER_PRICE_UP, ORDER_PRICE_DOWN, ORDER_SALE_UP, ORDER_SALE_DOWN, HTTP_USER_EXIST, HTTP_OK, ORDER_STATUS_NOT_PAY, \
